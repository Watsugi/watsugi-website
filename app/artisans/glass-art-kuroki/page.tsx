export default function GlassArtKurokiPage() {
  return (
      ...
      <section className="px-8 py-24 md:px-16 lg:px-24">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mb-10 text-5xl font-semibold leading-tight md:text-7xl">
            Glass shaped by light,
            <br />
            color, and human skill.
          </h1>
         <div className="mb-16 overflow-hidden rounded-[32px]">
  <img
    src="/images/glass-art-kuroki/hero.jpg"
    alt="Glass Art Kuroki artisans at work"
